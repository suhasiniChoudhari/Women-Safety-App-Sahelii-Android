...
public class SOShome extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if ((number1.equalsIgnoreCase("NONE")) && (number2.equalsIgnoreCase("NONE")) && (number3.equalsIgnoreCase("NONE"))) {
            ...
            String numbers = "SOS Will Be Sent To:\n" + number1 + "\n" + number2 + "\n" + number3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soshome);
    ...
    public void PopupMenu(View view) {
        PopupMenu popupMenu = new PopupMenu(SOShome.this,view);
        popupMenu.getMenuInflater().inflate(R.menu.popup,popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.changeNum){
                    startActivity(new Intent(SOShome.this,RegisterNumberActivity.class));
                }
                return true;
            }
        });
